...
const Sidebar = ({ isOpen, toggleSidebar }) => {
    ...
    return (
        <>
            {/* Sidebar - fixed on mobile, regular position on desktop */}
            <div className={`
                lg:w-64 bg-[#0a1e46] h-full flex flex-col z-50
            ...
            `}>
                <div className="p-4 flex justify-between items-center">
                    ...
                    <button
                        ...
                        className="text-white hover:bg-blue-900/50 rounded-full p-1 lg:hidden"
                    >
                        <X className="h-5 w-5" />
                    </button>
                </div>
